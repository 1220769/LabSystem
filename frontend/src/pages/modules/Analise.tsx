...
/* análises numéricas: só dígitos e um separador decimal (sem letras) */
                      ...
                      <div key={r._id} className={`an-rr ${isCrit ? 'an-rr--crit' : ''}`}>
                        ...
                        <div className="an-rr-inputs">
                          <input className="an-input an-input--sm"
                            ...
                            value={entry.valor}
                            onChange={e => {
                              // análises numéricas não aceitam letras
                              const val  = ref?.tipo === 'text' ? e.target.value : soNumero(e.target.value)
